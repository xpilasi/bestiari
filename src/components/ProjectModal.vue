        ...
        <div class="modal-card relative bg-white rounded-3xl overflow-hidden shadow-2xl w-full max-w-4xl max-h-[92vh] flex flex-col md:flex-row">
          ...
          <div class="flex-1 overflow-y-auto flex flex-col justify-center px-7 py-8 sm:px-10 sm:py-10">
            ...
            <a
              ...
              class="inline-flex items-center gap-2 self-start px-6 py-3.5 bg-gradient-to-r from-[#8E2DFE] to-[#E61655] text-white text-sm font-semibold rounded-xl shadow-md shadow-purple-500/20 hover:shadow-lg hover:shadow-purple-500/35 hover:scale-[1.03] active:scale-[0.98] transition-all duration-200"
              style="font-family: Inter;"
            >
              Ver proyecto
