...
import fluidBgImage from '@/assets/img/bg/fluid-bg-pink.png'
import animalImage from '@/assets/img/animals/leona-cool.png'
import avatarImage from '@/assets/img/animals/coneja-cool.png'
...
export default {
  ...
  data() {
    return {
      heroTitle: '¿Tienes un proyecto o idea en mente? ',
      heroSubtitle: '',
      highlightedWord: 'mente', // Palabra que se va a destacar
      ...
      customGradientClasses: 'bg-gradient-to-b from-transparent to-pink-500',
