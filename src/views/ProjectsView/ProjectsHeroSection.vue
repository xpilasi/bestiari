...
export default {
  ...
  data() {
    return {
      ...
      customGradientClasses: 'bg-gradient-to-b from-transparent to-green-500',
...
<template>
  <section id="projects-hero" class="min-h-[93vh] lg:min-h-[91vh] bg-primary flex flex-col justify-start xl:justify-start py-0 xl:py-10  ">
    <HeroContent 
